...
namespace RootMotion.FinalIK {
	...
	public partial class IKSolverVR: IKSolver {
		...
		public class Arm: BodyPart {
            ...
            public Vector3 handRotationAdjust = Vector3.zero;
			...
			public void Solve(bool isLeft) {
				...
				if (rotationWeight >= 1f) {
					hand.solverRotation = rotation * Quaternion.Euler(handRotationAdjust);
				} else if (rotationWeight > 0f) {
					hand.solverRotation = Quaternion.Lerp (hand.solverRotation , rotation * Quaternion.Euler(handRotationAdjust), rotationWeight);
				}
			}
